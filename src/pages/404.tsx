  ...
  return (
    <>
      <NextSeo
        ...
        description={`Página não encontrada da plataforma de gerenciamento da ${process.env.NEXT_PUBLIC_STORE_NAME}.`}
        openGraph={{
          ...
          images: [
            {
              ...
              alt: `Página não encontrada | Plataforma ${process.env.NEXT_PUBLIC_STORE_NAME}`,
            },
            { url: `${process.env.NEXT_PUBLIC_APP_URL}/assets/images/logo.jpg` },
          ],
        }}
