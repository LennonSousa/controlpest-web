    ...
    return (
        <>
            <NextSeo
                ...
                description={`Detalhes do usuário da plataforma de gerenciamento da ${process.env.NEXT_PUBLIC_STORE_NAME}.`}
                openGraph={{
                    ...
                    images: [
                        {
                            ...
                            alt: `Detalhes do usuário | Plataforma ${process.env.NEXT_PUBLIC_STORE_NAME}.`,
                        },
                        { url: `${process.env.NEXT_PUBLIC_APP_URL}/assets/images/logo.jpg` },
                    ],
                }}
