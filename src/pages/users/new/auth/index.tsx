...
const NewCustomer: NextPage = ({ authenticated, user, token }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
    ...
    return (
        <>
            <NextSeo
                ...
                description={`Confirmar usuário da plataforma de gerenciamento da ${process.env.NEXT_PUBLIC_STORE_NAME}.`}
                openGraph={{
                    ...
                    images: [
                        {
                            ...
                            alt: `Confirmar usuário | Plataforma ${process.env.NEXT_PUBLIC_STORE_NAME}.`,
                        },
                        { url: `${process.env.NEXT_PUBLIC_APP_URL}/assets/images/logo.jpg` },
                    ],
                }}
