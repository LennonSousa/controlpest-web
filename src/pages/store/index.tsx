...
const EditStore: NextPage = () => {
    ...
    return (
        <>
            <NextSeo
                title="Editar loja"
                description={`Editar loja da plataforma de gerenciamento da ${process.env.NEXT_PUBLIC_STORE_NAME}.`}
                openGraph={{
                    ...
                    images: [
                        {
                            ...
                            alt: `Editar loja | Plataforma ${process.env.NEXT_PUBLIC_STORE_NAME}.`,
                        },
                        { url: `${process.env.NEXT_PUBLIC_APP_URL}/assets/images/logo.jpg` },
                    ],
                }}
                                                    ...
                                                    <Container className="content-page">
...

                                                        {
                                                            typeof window !== undefined && <>
                                                                ...
                                                                <TextEditor type="manager" data={data} />
                                                            </>
                                                        }
                                                    </Container>
                                            }
