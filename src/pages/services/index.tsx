...
import { Button, Col, Container, Form, Image, InputGroup, ListGroup, Modal, Row } from 'react-bootstrap';
...
import ServicesItem, { Service } from '../../components/Services';
...
const Services: NextPage = () => {
    ...
    async function handleServicesList() {
    ...
    function handleOnDragEnd(result: DropResult) {
        if (result.destination) {
            ...
            const updatedListDocs = produce(services, draft => {
                if (draft) {
            ...
            if (updatedListDocs) {
                setServices(updatedListDocs);
                saveOrder(updatedListDocs);
            }
        }
    }

    async function saveOrder(list: Service[]) {
    ...
    return (
        <>
            <NextSeo
                title="Serviços"
                description={`Serviços da plataforma de gerenciamento da ${process.env.NEXT_PUBLIC_STORE_NAME}.`}
                openGraph={{
                    ...
                    images: [
                        {
                            ...
                            alt: `Serviços | Plataforma ${process.env.NEXT_PUBLIC_STORE_NAME}.`,
                        },
                        { url: `${process.env.NEXT_PUBLIC_APP_URL}/assets/images/logo.jpg` },
                    ],
                }}
                            ...
                            can(user, "services", "update") ? <Container className="content-page">
                                                                                        ...
                                                                                        {(provided) => (
                                                                                            ...
                                                                                            >
                                                                                                <ServicesItem
                                                                                                    ...
                                                                                                    handleServicesList={handleServicesList}
                                                                                                />
                                                                                            </div>
                                                                                        )}
                                                        ...
                                                        <Col>
                                                            <Row>
                                                                <Col className="text-center">
                                                                    <p style={{ color: 'var(--gray)' }}>Nenhum serviço registrado.</p>
                                                                </Col>
                                                            </Row>
                                ...
                                <Modal show={showModalNewType} onHide={handleCloseModalType}>
                                    <Modal.Header closeButton>
                                        <Modal.Title>Criar um serviço</Modal.Title>
                                    </Modal.Header>
                                    <Formik
                                        initialValues={
                                            {
                                        ...
                                        onSubmit={async values => {
                                            ...
                                            try {
                                                ...
                                                console.log('error create service type.');
                                                console.log(err);
                                            }
