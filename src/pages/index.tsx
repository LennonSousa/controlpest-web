...
const Home: NextPage = () => {
  ...
  return (
    <>
      <NextSeo
        title="Bem-vindo(a)"
        description={`Bem-vindo(a) a plataforma de gerenciamento da ${process.env.NEXT_PUBLIC_STORE_NAME}.`}
        openGraph={{
          ...
          images: [
            {
              ...
              alt: `Bem-vindo(a) | Plataforma ${process.env.NEXT_PUBLIC_STORE_NAME}.`,
            },
            { url: `${process.env.NEXT_PUBLIC_APP_URL}/assets/images/logo.jpg` },
          ],
        }}
